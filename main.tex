...
% 填写个人信息
% 学院
\newcommand{\school}{ 管理与经济学部| College of Management and Economics} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@tju.edu.com}{youremail@tju.edu.com}
        \hspace{4em}
        % 手机号
...
% 如果有多页简历，请把页眉页脚和背景复制粘贴到第二页的内容之前
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.15\textwidth]{images/tjulogo_2.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/tjulogo_1.png}
        };
    \end{tikzpicture}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{0.82\textwidth}
            \section{\makebox[\widthof{\faAddressCard}][c]{\color{TJU_Blue}{\faAddressCard}}\quad 个人信息}
    ...
    \section{\makebox[\widthof{\faGraduationCap}][c]{\color{TJU_Blue}{\faGraduationCap}}\quad 教育背景}

    % 教育背景（本科生）
    % \vspace{-1em}
    % \begin{table}[h!]
    %     \begin{tabularx}{\textwidth}{XXp{\widthof{2021年 -- 预计2025年7月毕业}}}
    %         天津大学 & 电子信息工程 & 2021年 -- 预计2025年7月毕业\\
